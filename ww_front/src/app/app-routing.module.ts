...
const routes: Routes = [
  ...
  {path : 'categories/:catId/page/:pageId', component: CategoryComponent},
  {path : 'search/:sw/:cc/:ob/:o', component: SearchComponent},
  {path : 'add-product', component: AddProductComponent},
  {path : 'categories/:catId/:prodId/alter', component: AlterProductComponent},
